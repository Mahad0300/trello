/**
 * Admin Board Detail Page JavaScript
 * Drag & Drop, Mouse Drag-to-Scroll Grip, Card Edge Auto-scroll, Calendar Grid Generation
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderCalendarGrid(year, monthIdx) {
    ...
    for (let i = 0; i < 35; i++) {
      ...
      if (isCurrentMonth && !isWeekend && tasksMap[dayNumber]) {
  ...
  // Initialize Calendar Header & Month Grid
