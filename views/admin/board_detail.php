<?php
$page_title = 'Sprint 24 Architecture - Admin Panel';
$page_js = 'admin_board_detail.js';
...
<div class="board-header">
  <div class="board-title-group gap-12 flex-row">
    ...
    <span class="badge badge-primary font-weight-600"><i class="fa-solid fa-user-shield"></i> Admin View</span>
  </div>

  <div class="gap-16 flex-row">
    <!-- Enterprise Board View Tabs (Board, Calendar) -->
...
<div id="calendar-view-container" class="view-container calendar-view-wrapper" style="display: none;">
  ...
  <div class="cal-grid-wrapper">
    ...
    <div class="cal-month-grid">
      ...
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">20</div></div>
      <div class="cal-day-cell">
        <div class="cal-day-num">21</div>
        <div class="cal-event-pill cal-pill-purple cal-span-bar" data-modal-target="card-detail-modal">Implement Core Feature</div>
        <div class="cal-event-pill cal-pill-peach cal-span-bar" data-modal-target="card-detail-modal">Refactor Component Logic</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">22</div>
        <div class="cal-event-pill cal-pill-purple cal-span-bar-continue opacity-85" data-modal-target="card-detail-modal">Implement Core Feature</div>
        <div class="cal-event-pill cal-pill-peach cal-span-bar-continue opacity-85" data-modal-target="card-detail-modal">Refactor Component Logic</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">23</div>
        <div class="cal-event-pill cal-pill-purple cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-layer-group"></i></span> TM-02...</div>
        <div class="cal-event-pill cal-pill-mint cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-asterisk"></i></span> TM-04 Improve App Perform...</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">24</div>
        <div class="cal-event-pill cal-pill-blue cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-rotate"></i></span> TM-03 Update Database</div>
      </div>
      <div class="cal-day-cell"><div class="cal-day-num">25</div></div>
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">26</div></div>

      <!-- Week 2: Sun 27 - Sat 2 -->
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">27</div></div>
      <div class="cal-day-cell">
        <div class="cal-day-num">28</div>
        <div class="cal-event-pill cal-pill-mint cal-span-bar" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-asterisk"></i></span> TM-08 Adjust Responsive Layout</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">29</div>
        <div class="cal-event-pill cal-pill-mint cal-span-bar-continue" data-modal-target="card-detail-modal">TM-08 Adjust Responsive Layout</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">30</div>
        <div class="cal-event-pill cal-pill-blue cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-rotate"></i></span> TM-06 Update API Integration</div>
      </div>
      <div class="cal-day-cell"><div class="cal-day-num">31</div></div>
      <div class="cal-day-cell"><div class="cal-day-num">1</div></div>
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">2</div></div>

      <!-- Week 3: Sun 3 - Sat 9 -->
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">3</div></div>
      <div class="cal-day-cell">
        <div class="cal-day-num">4</div>
        <div class="cal-event-pill cal-pill-lavender cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-link"></i></span> TM-09 Enhance Error Handling</div>
        <div class="cal-event-pill cal-pill-peach cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-bolt"></i></span> TM-10 Review Code Quality</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">5</div>
        <div class="cal-event-pill cal-pill-rose cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-bookmark"></i></span> TM-10 Deploy Staging Build</div>
      </div>
      <div class="cal-day-cell"><div class="cal-day-num">6</div></div>
      <div class="cal-day-cell"><div class="cal-day-num">7</div></div>
      <div class="cal-day-cell"><div class="cal-day-num">8</div></div>
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">9</div></div>

      <!-- Week 4: Sun 10 - Sat 16 -->
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">10</div></div>
      <div class="cal-day-cell">
        <div class="cal-day-num">11</div>
        <div class="cal-event-pill cal-pill-mint cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-asterisk"></i></span> TM-12...</div>
        <div class="cal-event-pill cal-pill-blue cal-span-bar" data-modal-target="card-detail-modal">Update State Management</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">12</div>
        <div class="cal-event-pill cal-pill-blue cal-span-bar-continue" data-modal-target="card-detail-modal">Update State Management</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">13</div>
        <div class="cal-event-pill cal-pill-purple cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-layer-group"></i></span> TM-13...</div>
        <div class="cal-event-pill cal-pill-lavender cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-link"></i></span> TM-15 Fix Navigation Issues</div>
      </div>
      <div class="cal-day-cell"><div class="cal-day-num">14</div></div>
      <div class="cal-day-cell"><div class="cal-day-num">15</div></div>
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">16</div></div>

      <!-- Week 5: Sun 17 - Sat 23 -->
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">17</div></div>
      <div class="cal-day-cell">
        <div class="cal-day-num">18</div>
        <div class="cal-event-pill cal-pill-peach cal-span-bar" data-modal-target="card-detail-modal">Valid Input Validation</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">19</div>
        <div class="cal-event-pill cal-pill-peach cal-span-bar-end" data-modal-target="card-detail-modal">Valid Input Validation</div>
        <div class="cal-event-pill cal-pill-lavender cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-link"></i></span> TM-17...</div>
      </div>
      <div class="cal-day-cell">
        <div class="cal-day-num">20</div>
        <div class="cal-event-pill cal-pill-peach cal-icon-circle-wrap" data-modal-target="card-detail-modal"><span class="cal-icon-circle"><i class="fa-solid fa-sliders"></i></span> TM-18...</div>
      </div>
      <div class="cal-day-cell"><div class="cal-day-num">21</div></div>
      <div class="cal-day-cell"><div class="cal-day-num">22</div></div>
      <div class="cal-day-cell cal-day-cell-weekend"><div class="cal-day-num">23</div></div>
    </div>
  </div>
</div>
